...
const Cart = () => {
  ...
  const showPopup = (
    message: string,
    icon: keyof typeof MaterialIcons.glyphMap = "check-circle",
  ) => {
      ...
      >
        ...
        >
          ...
          <View className="flex-1 p-4 justify-between">
            <View>
              <Text
                className={`text-base font-extrabold ${darkMode ? "text-gray-100" : "text-gray-900"} mb-1`}
              >
                {item.nombre}
              </Text>
              {item.descripcion && (
            ...
            <View className="flex-row justify-between items-center">
              {item.precio_descuento ? (
                <View className="flex-row items-center gap-2">
                  <Text
                    ...
                    style={{ color: darkMode ? "#EAB308" : "#B8860B" }}
                  >
                    ${item.precio_descuento}
                  </Text>
              ...
              <View className="flex-row items-center gap-2">
                ...
                <Text
                  className={`text-base font-bold min-w-[18px] text-center ${darkMode ? "text-white" : "text-gray-900"}`}
                >
    ...
    <ScreenWrapper className="flex-1">
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        {carrito.length === 0 ? (
          <View className="flex-1 items-center justify-center mt-24 px-4">
            ...
            <Text
              className={`text-sm mt-1 ${darkMode ? "text-gray-500" : "text-gray-400"} text-center`}
            >
            ...
            <Animated.View entering={FadeInDown.delay(300).springify()}>
              ...
              >
                <View className="flex-row items-center gap-3">
                  <View
                    className={`w-10 h-10 rounded-full items-center justify-center ${metodo ? "bg-primary" : "bg-primary"}`}
                  >
                    <Ionicons
                  ...
                  <View>
                    ...
                    <Text
                      className={`text-base font-bold ${metodo ? "text-primary" : darkMode ? "text-white" : "text-primary"}`}
                    >
      ...
      >
        <View className="flex-1 justify-end bg-black/50">
          <View
            className={`rounded-t-3xl p-6 ${darkMode ? "bg-gray-800" : "bg-white"}`}
          >
                ...
                >
                  ...
                  >
                    <View className="flex-row items-center gap-3">
                      ...
                      <Text
                        className={`text-base font-semibold ${darkMode ? "text-gray-100" : "text-gray-800"}`}
                      >
                        {op.nombre}
                      </Text>
                    </View>
            ...
            >
              <Text
                className={`font-semibold ${darkMode ? "text-gray-300" : "text-gray-600"}`}
              >
                Cancelar
              </Text>
            </TouchableOpacity>
